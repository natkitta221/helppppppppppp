                                    ...
                                    <div class="mt-5 pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                                        ...
                                        <div>
                                            ...
                                            @elseif($existingReq && $existingReq->status === 'accepted')
                                                <a href="{{ route('exchange-requests.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-100 hover:bg-emerald-200 text-emerald-800 border border-emerald-300 text-xs sm:text-sm font-extrabold transition-all">
                                                    <span>📞</span> <span>ดูข้อมูลติดต่อคู่แลกเปลี่ยน</span>
                                                </a>
                                            @else
