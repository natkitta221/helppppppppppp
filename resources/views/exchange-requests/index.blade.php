                    ...
                    @foreach($receivedRequests as $request)
                        ...
                        <div class="bg-white rounded-3xl border border-slate-200/90 shadow-sm hover:shadow-md transition-all overflow-hidden">
                            ...
                            <div class="p-5 sm:p-6">
                                ...
                                {{-- ================================================= --}}
                                {{-- CONTACT INFO : RECEIVED / ACCEPTED ONLY --}}
                                {{-- ================================================= --}}
                                @if($request->status === 'accepted')

                                    @php
                                        $contact = $exchangeContacts->get($request->requester_id);
                                    @endphp

                                    <div class="mt-5 p-5 bg-indigo-50/60 border border-indigo-100 rounded-2xl">
                                        ...
                                        <div class="flex items-center gap-2 mb-4">
                                            ...
                                            <div>
                                                <h4 class="font-bold text-slate-800">
                                                    ข้อมูลติดต่อคู่แลกเปลี่ยน
                                                </h4>

                                                <p class="text-xs text-slate-500 mt-0.5">
                                                    คุณยอมรับคำขอแล้ว สามารถติดต่อคู่แลกเปลี่ยนได้
                                                </p>
                                            </div>
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            @if($contact?->exchange_area)
                                                ...
                                                <div class="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-100">
                                                    ...
                                                    <div>
                                                        <p class="text-[11px] text-slate-400">
                                                            พื้นที่สะดวกแลกเปลี่ยน
                                                        </p>

                                                        <p class="text-sm font-semibold text-slate-700">
                                                            {{ $contact->exchange_area }}
                                                        </p>
                                                    </div>
                                            ...
                                            @if(!$contact?->line_id && !$contact?->phone && !$contact?->exchange_area)

                                                <p class="text-sm text-slate-500 text-center py-2">
                                                    ผู้ใช้ยังไม่ได้ระบุข้อมูลติดต่อ
                                                </p>
                                        ...
                                        <div class="mt-4 p-3 bg-amber-50 border border-amber-100 rounded-xl">
                                            ...
                                            <p class="text-[11px] leading-5 text-amber-700">
                                                🛡️ เพื่อความปลอดภัย ควรนัดแลกเปลี่ยนในสถานที่สาธารณะ
                                                และหลีกเลี่ยงการส่งข้อมูลสำคัญให้ผู้อื่น
                                            </p>
                    ...
                    @foreach($sentRequests as $request)
                        ...
                        <div class="bg-white rounded-3xl border border-slate-200/90 shadow-sm hover:shadow-md transition-all overflow-hidden">
                            ...
                            <div class="p-5 sm:p-6">
                                ...
                                {{-- ================================================= --}}
                                {{-- CONTACT INFO : SENT / ACCEPTED ONLY --}}
                                {{-- ================================================= --}}
                                @if($request->status === 'accepted')

                                    @php
                                        $contact = $exchangeContacts->get($request->receiver_id);
                                    @endphp
                                    ...
                                    <div class="mt-5 p-5 bg-indigo-50/60 border border-indigo-100 rounded-2xl">
                                        ...
                                        <div class="flex items-center gap-2 mb-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-slate-500 mt-0.5">
                                                    คู่แลกเปลี่ยนยอมรับคำขอแล้ว สามารถติดต่อกันได้
                                                </p>
